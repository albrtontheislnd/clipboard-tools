...
export const miscellaneousSymbols: SymbolTab[] = [
  {
    ...
    symbols: [
      [
        ...
        { display: '℘', latex: '\\wp', tooltip: '\\wp' },
        { display: '∇', latex: '\\nabla', tooltip: '\\nabla' },
        { display: '∃', latex: '\\exists', tooltip: '\\exists' },
        { display: '∠', latex: '\\angle', tooltip: '\\angle' },
      ...
      [
        ...
        { display: '∅', latex: '\\varnothing', tooltip: '\\varnothing' },
        { display: 'Ⅽ', latex: '\\complement', tooltip: '\\complement' },
        { display: '▽', latex: '\\triangledown', tooltip: '\\triangledown' },
        { display: '△', latex: '\\triangle', tooltip: '\\triangle' },
      ...
      [
        ...
        { display: '⋮', latex: '\\vdots', tooltip: '\\vdots' },
        { display: '∭', latex: '\\iiiint', tooltip: '\\iiiint' },
        { display: '⋰', latex: '\\ldots', tooltip: '\\ldots' },
